...
export const metadata: Metadata = buildMetadata({
  title: 'À propos',
  description: 'Le Protocole · Journal : un media independant pour aider les personnes en rupture amoureuse a traverser cette periode et a mieux comprendre ce qui se passe.',
  path: '/a-propos',
});
    ...
    <div className="container-prose pt-20 md:pt-24 pb-16 md:pb-20">
      ...
      <div className="mt-10 max-w-[72ch]">
        <p className="font-sans italic text-xl text-ink-700 leading-snug">
          Le Protocole · Journal est un media independant sur la rupture amoureuse, le no contact
          et la reconquete. Pour les moments ou on ne sait plus quoi faire, quoi penser, quoi ressentir.
        </p>
        ...
        <p className="mt-4 text-lg text-ink-700 leading-relaxed">
          Apres une rupture, on cherche des reponses. Pourquoi ca s&apos;est termine ? Que pense mon ex ?
          Le no contact, ca sert a quoi vraiment ? Les forums regorgent d&apos;avis contradictoires.
          Ce journal existe pour apporter de la clarte : des articles structures, appuyes sur la
          psychologie de l&apos;attachement et l&apos;experience de terrain, sans promesses magiques.
        </p>
        <p className="mt-4 text-lg text-ink-700 leading-relaxed">
          On couvre les deux familles d&apos;intention : ceux qui souffrent et cherchent a tenir,
          et ceux qui veulent comprendre comment recuperer leur ex de facon saine.
        </p>
        ...
        <p className="mt-4 text-lg text-ink-700 leading-relaxed">
          Trois accompagnants specialises en relations et reconstruction apres rupture.
          Chacun couvre son domaine de competence.
        </p>
        ...
        <ul className="mt-4 space-y-2 text-lg text-ink-700 leading-relaxed pl-5 marker:text-accent-500 list-disc">
          <li>Pas de manipulation ou de techniques de contr&ocirc;le. Notre approche est ethique : comprendre, pas manipuler.</li>
          <li>Pas de promesses que ton ex reviendra. On ne peut pas predir l&apos;avenir d&apos;une relation.</li>
          <li>Pas de contenu qui remplace un suivi psychologique. Si tu souffres intensement, consulte un professionnel de sante mentale.</li>
        ...
        <p className="mt-4 text-lg text-ink-700 leading-relaxed">
          ...
          , un programme complet (37 euros) pour traverser la premiere semaine apres une rupture.
          Si les articles de ce journal t&apos;aident, le programme va plus loin avec une methode structuree.
        </p>
        <p className="mt-4 text-lg text-ink-700 leading-relaxed">
